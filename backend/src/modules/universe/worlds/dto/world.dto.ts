...
export class WorldDto {
  @ApiProperty({
    ...
    description: 'Унікальний ідентифікатор світу',
  })
  @Expose()
  id!: string;
  ...
  @ApiProperty({
    example: '123e4567-e89b-12d3-a456-426614174000',
    description: 'ID власника світу (користувача)',
  })
  @Expose()
  ownerId!: string;
  ...
  @ApiProperty({
    example: 'Дивовижний світ магії та пригод...',
  ...
  @ApiPropertyOptional({
    description:
      'Деталі лору світу (атмосфера, масштаб, система магії, географія, фракції)',
    example: {
  ...
  @ApiPropertyOptional({
    type: () => [CharacterDto],
    description: 'Персонажі цього світу',
  })
  @Expose()
  @Type(() => CharacterDto)
